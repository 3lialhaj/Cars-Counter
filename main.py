...
cap = cv2.VideoCapture(r"C:\Users\ali20\OneDrive\Desktop\TaxiCounter\video.mp4")
...
while True:
    ...
    # Resize mask to match the video frame size if they do not match
